...
### Screenshot Tool — DkZ Screen Capture
...
![Lines](https://img.shields.io/badge/Lines-409-ffb800?style=for-the-badge)
...
```mermaid
graph TB
    A[Screenshot Tool] --> B[index.html]
    A --> C[style.css]
    A --> D[script.js]
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-screenshot-tool.git

# Oeffnen
cd dkz-screenshot-tool
